...
const LAIA_KNOWLEDGE = {
    greetings: [
        "¡Hola! Soy Laia, tu asistente virtual de VerbaDoc Salud 🏥. Mi nombre es de origen griego y significa 'mujer que se expresa con facilidad'. ¿En qué puedo ayudarte hoy?",
        "¡Bienvenido! Soy Laia, mi nombre es de origen griego y significa 'mujer que se expresa con facilidad'. Estoy aquí para ayudarte con VerbaDoc Salud. ¿Qué necesitas saber?",
    ],
    whatIsVerbadoc: "**VerbaDoc Salud** es una herramienta especializada de extracción inteligente de datos médicos que utiliza **Inteligencia Artificial** para procesar documentos del sector sanitario.\n\n✅ Especializado en Salud - Plantillas para documentos médicos\n✅ 8 especialidades médicas predefinidas\n✅ 100% Procesamiento en Europa (Bélgica)\n✅ Cumplimiento RGPD e HIPAA Compatible\n✅ IA Gemini procesada en servidores europeos\n✅ Sin almacenamiento permanente de documentos",
    ...
    documentTypes: "**TIPOS DE DOCUMENTOS MÉDICOS:**\n\n🏥 **GENERAL:**\n✅ Recetas médicas\n✅ Certificados médicos (bajas, aptitud)\n✅ Consultas médicas\n✅ Registros de vacunación\n✅ Altas hospitalarias\n\n🔬 **ESPECIALIDADES:**\n✅ Análisis clínicos y laboratorio\n✅ Electrocardiogramas (ECG)\n✅ Ecocardiogramas\n✅ Informes traumatológicos\n✅ Exámenes oftalmológicos\n✅ Historias clínicas pediátricas\n✅ Informes quirúrgicos\n✅ Informes radiológicos (TAC, Resonancias)\n\n📋 **OTROS:**\n✅ Documentos médicos manuscritos\n✅ Pruebas diagnósticas variadas",
